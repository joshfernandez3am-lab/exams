...
stopifnot(any(grepl('maxattempts="0"', lm_qti, fixed = TRUE)))
...
stopifnot(any(grepl('<Question QRef="il_0_qst_[0-9]+"', lm_qpl, perl = TRUE)))
stopifnot(any(grepl('<TriggerQuestion Id="[0-9]+"></TriggerQuestion>', lm_qpl, perl = TRUE)))
...
stopifnot(any(grepl('maxattempts="0"', vowels_qti, fixed = TRUE)))
...
stopifnot(any(grepl('maxattempts="0"', ttest_qti, fixed = TRUE)))
